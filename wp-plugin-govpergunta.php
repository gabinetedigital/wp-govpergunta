...
$results = $wpdb->get_results("select wp.* from wp_posts wp inner join wp_postmeta wpm on wp.id = wpm.post_id where wp.post_type = 'contrib_govpergunta' and wpm.meta_key='wp_govpergunta_contribuicao_relacinada' and wpm.meta_value='PRINCIPAL'");
